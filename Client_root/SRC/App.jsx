  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", color: "#f8fafc" }}>
      <div style={{ background: "linear-gradient(135deg, #1e1b4b 0%, #312e81 100%)", border: "1px solid rgba(56, 189, 248, 0.25)", padding: "36px", borderRadius: "28px", boxShadow: "0 20px 35px rgba(0,0,0,0.3)" }}>
        <span style={{ fontSize: "11px", fontWeight: "600", letterSpacing: "0.08em", color: "#38bdf8", background: "rgba(56, 189, 248, 0.15)", padding: "5px 12px", borderRadius: "999px", textTransform: "uppercase" }}>Project Nimit</span>
        ...
        <p style={{ fontSize: "16px", color: "#cbd5e1", margin: "0 0 24px 0", fontWeight: "500", lineHeight: "1.6" }}>
          Nimit bridges live telemetry forecasts with official municipal advisories to provide safe, verified guidance. By integrating real-time atmospheric indices, precipitation curves, and dynamic risk assessments, our platform empowers users to make informed daily travel and safety decisions.
        </p>
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", padding: "4px", marginBottom: "32px" }}>
            ...
            <div style={{ overflow: "hidden", whiteSpace: "nowrap", opacity: isExpanded ? 1 : 0, transition: "opacity 0.2s" }}>
              <h1 style={{ fontFamily: "'Outfit', sans-serif", fontSize: "16px", fontWeight: "700", color: "#f8fafc", margin: 0, letterSpacing: "0.03em" }}>NIMIT</h1>
